package cl.javierchacana.config;
...
@Configuration
@EnableMongoRepositories("cl.javierchacana.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("cl.javierchacana.config.dbmigrations");
